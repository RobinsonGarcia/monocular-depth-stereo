...
from xlightning.models.depth.glp.models.mit import mit_b4

class GLPDepth(nn.Module):
    def __init__(self, max_depth=10.0, is_train=False,**kwargs):
        super().__init__()
        self.max_depth = max_depth
        f=int(kwargs['SIZE']/224)
        kwargs['patch_size']*=f
        self.encoder = mit_b4(img_size=kwargs['SIZE'],**kwargs)


        """
        if is_train:            
            ckpt_path = '.tmp/mit_b4.pth'
            #self.encoder = None
            try:
